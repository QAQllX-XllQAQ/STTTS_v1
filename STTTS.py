...
if __name__ == '__main__':
    ...
    console.print("[bold cyan]F6[/bold cyan]: Read Text")
    ...
    def reading():
        ...
        console.print("[bold green]Reading text...[/bold green]")
        ...
        try:
            ...
            for voice in voices:
                if 'chinese' in voice.name.lower() or 'zh' in voice.languages:
                    engine.setProperty('voice', voice.id)
                break
            engine.say(full_sentences)
            engine.runAndWait()
            engine.stop()  # 清理资源
        except RuntimeError as e:
            console.print(f"[bold red]Error in text-to-speech: {e}[/bold red]")
        console.print("[bold green]Reading text...[/bold green]")
        console.print(full_sentences)
    ...
    keyboard.add_hotkey('F9', mute_microphone, suppress=True)
    keyboard.add_hotkey('F10', unmute_microphone, suppress=True)
    keyboard.add_hotkey('F4', start_static_recording, suppress=True)
    keyboard.add_hotkey('F5', stop_static_recording, suppress=True)
    keyboard.add_hotkey('num sub', reset_transcription, suppress=True)
